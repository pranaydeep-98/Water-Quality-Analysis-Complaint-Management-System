...
const SubmitComplaint = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setServerError('Error submitting complaint: ' + (err.response?.data?.message || err.message));
    } finally {
      setLoading(false);
    }
  };
         ...
         <div className="main-form glass-card">
            ...
            <form onSubmit={handleSubmit}>
               ...
               <div className="form-actions mt-4 align-right">
                  <button type="submit" className="btn-primary submit-btn-large" disabled={loading}>
